...
def train_voting_clf(training_folder):
    start_time = time.time()

    dataset_url = training_folder + "bbb_penetration_modified.txt"
    desc_url = training_folder + "bbb_penetration_molecular_descriptors.csv"
