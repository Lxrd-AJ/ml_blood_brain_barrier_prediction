...
\chapter{Machine Learning Classifiers}
	...
	\section{Machine Learning Models}
		...
		\subsection{Support Vector Machines(Notes)}
		...
		\subsection{Decision Trees(Notes)}
		...
		\subsection{Neural Networks(Notes)}
				...
				\begin{mdframed}[]
					...
					\end{itemize}
				\end{mdframed}
		\subsection{Ensemble Classifiers(Notes)}
