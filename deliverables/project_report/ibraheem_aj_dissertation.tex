...
\chapter{Model Evaluation and Persistence}
	\section{Model Evaluation}
		The next step after training the classifier is to evaluate their performance. There are a myriad of techniques available for evaluating classifier performance and these techniques help us answer two basic questions about the model, which are:
			\begin{itemize}
